...
n_classes=20
b_size=64
weight_path="./checkpoint/ViT/ViT-Cifar20-best.pth"
...
for val in "${StringArray[@]}"; do
    ...
    reset_cuda
    CUDA_VISIBLE_DEVICES=$DEVICE python forget_full_class_main.py -net ViT -dataset $dataset -classes $n_classes -gpu -b $b_size -method ssd_tuning_loss_free -forget_class $forget_class -weight_path $weight_path -seed $seed
    reset_cuda
