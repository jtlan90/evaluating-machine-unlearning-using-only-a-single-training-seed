...
wandb.init(
    project=f"Methodology_Comparison_{args.net}_{args.dataset}_subclass",
    name=f"{args.method}",
    group=f"Seed{args.seed}_{args.dataset}_subclass_{args.forget_class}",
