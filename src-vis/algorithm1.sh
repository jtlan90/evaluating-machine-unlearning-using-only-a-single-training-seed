...
python pretrain_model.py -net ResNet18 -dataset Cifar20 -classes 20 -gpu -seed 1
python pretrain_model.py -net ResNet18 -dataset Cifar100 -classes 100 -gpu -seed 1

# Pre-train the model resnet18 on PinsFaceRecognition
# python pretrain_model.py -net resnet18 -dataset PinsFaceRecognition -classes 105 -gpu

# # Pre-train the model ViT on CIFAR10, CIFAR20, CIFAR100, CIFAR20 with subclasses
# python pretrain_model.py -net ViT -dataset Cifar20 -classes 20 -gpu -seed 1
# python pretrain_model.py -net ViT -dataset Cifar100 -classes 100 -gpu -seed 1
